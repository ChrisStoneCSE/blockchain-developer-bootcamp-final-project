...
const ssAddress = '0XD9145CCE52D386F254917E481EB44E9943F39138'
...
ssSubmit.onclick = async () => {
  ...
  await grantMgmt.methods.store(ssInputValue).send({from: ethereum.selectedAddress})
}
...
ssGetValue.onclick = async () => {
  ...
  var value = await grantMgmtStorage.methods.retrieve().call()
